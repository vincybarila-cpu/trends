...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,675.36", change: "-0.25%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,018.06", change: "-0.38%", status: "negative", estimated: false },
