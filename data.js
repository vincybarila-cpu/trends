...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,569.94", change: "-0.93%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,343.93", change: "-0.07%", status: "negative", estimated: false },
