...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,683.93", change: "-0.06%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,286.90", change: "-0.12%", status: "negative", estimated: false },
