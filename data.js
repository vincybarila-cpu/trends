...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,634.97", change: "-0.15%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,264.93", change: "-0.21%", status: "negative", estimated: false },
