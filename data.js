...
export const TRENDS_DATA = {
  indices: [
    { symbol: "SPX", name: "S&P 500", value: "7,537.43", change: "+0.72%", status: "positive", estimated: false },
    { symbol: "IXIC", name: "Nasdaq Composite", value: "26,121.16", change: "+0.31%", status: "positive", estimated: false },
    { symbol: "DJI", name: "Dow Jones", value: "53,055.91", change: "+1.44%", status: "positive", estimated: false },
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,191.44", change: "+0.71%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,768.77", change: "-0.04%", status: "negative", estimated: false },
    { symbol: "N225", name: "Nikkei 225", value: "68,256.96", change: "-2.12%", status: "negative", estimated: false }
  ],
