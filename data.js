...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "N225", name: "Nikkei 225", value: "64,951.51", change: "+1.15%", status: "positive", estimated: false }
  ],
