...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,748.74", change: "+0.10%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,440.31", change: "+0.53%", status: "positive", estimated: false },
