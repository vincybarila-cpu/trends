...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "DJI", name: "Dow Jones", value: "51,778.00", change: "-0.60%", status: "negative", estimated: false },
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,868.05", change: "-0.19%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,506.14", change: "-0.12%", status: "negative", estimated: false },
    { symbol: "N225", name: "Nikkei 225", value: "65,018.95", change: "+1.38%", status: "positive", estimated: false }
  ],
