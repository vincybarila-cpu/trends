...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,810.09", change: "-1.08%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "24,821.23", change: "-0.38%", status: "negative", estimated: false },
