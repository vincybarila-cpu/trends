...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,562.48", change: "-0.47%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "24,940.12", change: "-0.69%", status: "negative", estimated: false },
