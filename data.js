...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,603.48", change: "-2.25%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "24,922.03", change: "-0.93%", status: "negative", estimated: false },
