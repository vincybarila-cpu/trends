...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,775.61", change: "+0.75%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,116.09", change: "-0.01%", status: "negative", estimated: false },
