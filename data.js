...
export const TRENDS_DATA = {
  indices: [
    { symbol: "SPX", name: "S&P 500", value: "7,481.38", change: "-1.20%", status: "negative", estimated: false },
    { symbol: "IXIC", name: "Nasdaq Composite", value: "25,506.05", change: "-2.91%", status: "negative", estimated: false },
    { symbol: "DJI", name: "Dow Jones", value: "52,488.97", change: "-0.32%", status: "negative", estimated: false },
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,692.45", change: "-1.37%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "24,787.65", change: "-0.85%", status: "negative", estimated: false },
    { symbol: "N225", name: "Nikkei 225", value: "64,141.12", change: "-4.03%", status: "negative", estimated: false }
  ],
