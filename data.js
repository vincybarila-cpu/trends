...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,967.89", change: "-1.16%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,120.18", change: "-0.83%", status: "negative", estimated: false },
