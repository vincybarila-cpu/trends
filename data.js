...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,863.53", change: "-1.04%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "24,682.50", change: "-1.27%", status: "negative", estimated: false },
