...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,840.47", change: "+0.29%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,399.06", change: "+0.99%", status: "positive", estimated: false },
