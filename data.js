...
export const TRENDS_DATA = {
  indices: [
    { symbol: "SPX", name: "S&P 500", value: "7,387.02", change: "-0.29%", status: "negative", estimated: false },
    { symbol: "IXIC", name: "Nasdaq Composite", value: "24,816.96", change: "-1.28%", status: "negative", estimated: false },
    { symbol: "DJI", name: "Dow Jones", value: "52,030.19", change: "+0.62%", status: "positive", estimated: false },
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,054.95", change: "+1.44%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,361.03", change: "+2.41%", status: "positive", estimated: false },
    { symbol: "N225", name: "Nikkei 225", value: "64,931.19", change: "+0.50%", status: "positive", estimated: false }
  ],
