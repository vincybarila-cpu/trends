...
export const TRENDS_DATA = {
  indices: [
    { symbol: "SPX", name: "S&P 500", value: "7,407.32", change: "-1.22%", status: "negative", estimated: false },
    { symbol: "IXIC", name: "Nasdaq Composite", value: "25,013.98", change: "-2.63%", status: "negative", estimated: false },
    { symbol: "DJI", name: "Dow Jones", value: "51,850.94", change: "-0.70%", status: "negative", estimated: false },
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,673.36", change: "-2.12%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "24,985.16", change: "-0.68%", status: "negative", estimated: false },
    { symbol: "N225", name: "Nikkei 225", value: "64,611.15", change: "-2.73%", status: "negative", estimated: false }
  ],
