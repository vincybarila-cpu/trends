...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,765.26", change: "+0.15%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,424.94", change: "+1.09%", status: "positive", estimated: false },
