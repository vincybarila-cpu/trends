...
export const TRENDS_DATA = {
  indices: [
    { symbol: "SPX", name: "S&P 500", value: "7,675.70", change: "+0.30%", status: "positive", estimated: false },
    { symbol: "IXIC", name: "Nasdaq Composite", value: "26,130.20", change: "+0.58%", status: "positive", estimated: false },
    { symbol: "DJI", name: "Dow Jones", value: "53,463.88", change: "+0.09%", status: "positive", estimated: false },
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,686.38", change: "-0.06%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,355.04", change: "+0.34%", status: "positive", estimated: false },
    { symbol: "N225", name: "Nikkei 225", value: "66,131.98", change: "-0.20%", status: "negative", estimated: false }
  ],
