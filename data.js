...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,909.08", change: "-0.89%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "24,861.91", change: "-0.22%", status: "negative", estimated: false },
