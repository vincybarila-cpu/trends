...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,868.19", change: "-0.96%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,399.15", change: "-0.69%", status: "negative", estimated: false },
