...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,813.80", change: "+0.52%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,323.43", change: "+0.83%", status: "positive", estimated: false },
