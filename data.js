...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,750.35", change: "-0.59%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,569.13", change: "+0.82%", status: "positive", estimated: false },
