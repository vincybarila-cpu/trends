...
export const TRENDS_DATA = {
  indices: [
    { symbol: "SPX", name: "S&P 500", value: "7,686.14", change: "-0.58%", status: "negative", estimated: false },
    { symbol: "IXIC", name: "Nasdaq Composite", value: "26,370.89", change: "-0.64%", status: "negative", estimated: false },
    { symbol: "DJI", name: "Dow Jones", value: "53,185.90", change: "-0.72%", status: "negative", estimated: false },
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,612.69", change: "+0.67%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,258.11", change: "-0.41%", status: "negative", estimated: false },
    { symbol: "N225", name: "Nikkei 225", value: "66,311.93", change: "-0.14%", status: "negative", estimated: false }
  ],
