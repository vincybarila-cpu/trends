...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,826.27", change: "+0.25%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,456.69", change: "+0.60%", status: "positive", estimated: false },
