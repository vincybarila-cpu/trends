...
export const TRENDS_DATA = {
  indices: [
    { symbol: "SPX", name: "S&P 500", value: "7,533.77", change: "-0.13%", status: "negative", estimated: false },
    { symbol: "IXIC", name: "Nasdaq Composite", value: "25,881.95", change: "-0.86%", status: "negative", estimated: false },
    { symbol: "DJI", name: "Dow Jones", value: "52,552.97", change: "+0.09%", status: "positive", estimated: false },
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,373.96", change: "-0.93%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "24,915.49", change: "-0.92%", status: "negative", estimated: false },
    { symbol: "N225", name: "Nikkei 225", value: "63,896.48", change: "-4.40%", status: "negative", estimated: false }
  ],
