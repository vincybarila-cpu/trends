...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,267.36", change: "-0.59%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,227.71", change: "-0.80%", status: "negative", estimated: false },
