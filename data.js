...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,116.59", change: "-0.88%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,145.88", change: "-0.73%", status: "negative", estimated: false },
