...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,042.67", change: "-1.02%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,127.63", change: "-0.80%", status: "negative", estimated: false },
