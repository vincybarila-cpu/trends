...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,643.33", change: "+0.50%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,034.74", change: "-0.33%", status: "negative", estimated: false },
