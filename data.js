...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "N225", name: "Nikkei 225", value: "66,067.91", change: "+3.00%", status: "positive", estimated: false }
  ],
