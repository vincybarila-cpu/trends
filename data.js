...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,012.15", change: "-1.07%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,134.03", change: "-0.78%", status: "negative", estimated: false },
