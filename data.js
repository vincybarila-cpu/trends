...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,789.88", change: "-2.21%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "24,940.21", change: "-3.40%", status: "negative", estimated: false },
