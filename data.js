...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,691.09", change: "+0.02%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,365.70", change: "+0.86%", status: "positive", estimated: false },
