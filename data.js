...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,780.58", change: "+0.16%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,422.95", change: "+0.47%", status: "positive", estimated: false },
