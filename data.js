...
export const TRENDS_DATA = {
  indices: [
    { symbol: "SPX", name: "S&P 500", value: "7,670.37", change: "-0.21%", status: "negative", estimated: false },
    { symbol: "IXIC", name: "Nasdaq Composite", value: "26,211.24", change: "-0.61%", status: "negative", estimated: false },
    { symbol: "DJI", name: "Dow Jones", value: "53,129.87", change: "-0.11%", status: "negative", estimated: false },
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,828.08", change: "-1.49%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,871.61", change: "-1.47%", status: "negative", estimated: false },
    { symbol: "N225", name: "Nikkei 225", value: "64,325.64", change: "-2.85%", status: "negative", estimated: false }
  ],
