...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,749.85", change: "-0.51%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,959.92", change: "-0.64%", status: "negative", estimated: false },
