...
export const TRENDS_DATA = {
  indices: [
    { symbol: "SPX", name: "S&P 500", value: "7,704.13", change: "-0.02%", status: "negative", estimated: false },
    { symbol: "IXIC", name: "Nasdaq Composite", value: "26,939.37", change: "+0.01%", status: "positive", estimated: false },
    { symbol: "DJI", name: "Dow Jones", value: "51,349.98", change: "-0.31%", status: "negative", estimated: false },
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,543.45", change: "-0.85%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,266.53", change: "-0.57%", status: "negative", estimated: false },
    { symbol: "N225", name: "Nikkei 225", value: "66,071.17", change: "+0.85%", status: "positive", estimated: false }
  ],
  ...
  instruments: [
    ...
    },
    {
      ...
      currentPrice: "5.11% (Rendimento)",
      changePercent: "+0.15 pt",
      status: "positive",
      estimated: false,
      historicalYields: [
    ...
    },
    {
      ...
      currentPrice: "4.85% (Rendimento)",
      changePercent: "+0.14 pt",
      status: "positive",
      estimated: false,
      historicalYields: [
    ...
    },
    {
      ...
      currentPrice: "3.99% (Rendimento)",
      changePercent: "+0.11 pt",
      status: "positive",
      estimated: false,
      historicalYields: [
