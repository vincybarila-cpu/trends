...
export const TRENDS_DATA = {
  indices: [
    { symbol: "SPX", name: "S&P 500", value: "7,543.59", change: "-0.42%", status: "negative", estimated: false },
    { symbol: "IXIC", name: "Nasdaq Composite", value: "26,107.01", change: "-0.66%", status: "negative", estimated: false },
    { symbol: "DJI", name: "Dow Jones", value: "52,508.27", change: "-0.24%", status: "negative", estimated: false },
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,862.50", change: "+0.47%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,147.03", change: "+0.32%", status: "positive", estimated: false },
    { symbol: "N225", name: "Nikkei 225", value: "68,722.57", change: "+1.45%", status: "positive", estimated: false }
  ],
