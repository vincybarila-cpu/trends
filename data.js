...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,656.14", change: "-0.64%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,259.54", change: "-0.59%", status: "negative", estimated: false },
