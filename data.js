...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,651.94", change: "-2.16%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "24,956.92", change: "-0.79%", status: "negative", estimated: false },
