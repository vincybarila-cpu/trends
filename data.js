...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,818.25", change: "+2.35%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,797.37", change: "+3.02%", status: "positive", estimated: false },
