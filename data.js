...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,230.18", change: "-0.66%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,216.95", change: "-0.84%", status: "negative", estimated: false },
