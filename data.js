...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,272.15", change: "+1.39%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,716.23", change: "+1.24%", status: "positive", estimated: false },
  ...
  instruments: [
    ...
    },
    {
      ...
      currentPrice: "5.00% (Rendimento)",
      changePercent: "+0.03 pt",
      status: "positive",
      estimated: false,
      historicalYields: [
