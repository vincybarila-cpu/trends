...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,801.56", change: "+0.20%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,466.94", change: "+0.64%", status: "positive", estimated: false },
