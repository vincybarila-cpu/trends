...
export const TRENDS_DATA = {
  indices: [
    { symbol: "SPX", name: "S&P 500", value: "7,408.30", change: "-1.34%", status: "negative", estimated: false },
    { symbol: "IXIC", name: "Nasdaq Composite", value: "25,137.69", change: "-2.71%", status: "negative", estimated: false },
    { symbol: "DJI", name: "Dow Jones", value: "51,711.65", change: "-0.98%", status: "negative", estimated: false },
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,315.84", change: "-1.85%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "24,763.12", change: "-0.99%", status: "negative", estimated: false },
    { symbol: "N225", name: "Nikkei 225", value: "66,422.60", change: "+0.46%", status: "positive", estimated: false }
  ],
