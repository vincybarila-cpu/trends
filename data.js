...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,681.02", change: "-0.64%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,969.08", change: "-0.61%", status: "negative", estimated: false },
