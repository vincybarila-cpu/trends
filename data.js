...
export const TRENDS_DATA = {
  indices: [
    { symbol: "SPX", name: "S&P 500", value: "7,656.98", change: "+0.27%", status: "positive", estimated: false },
    { symbol: "IXIC", name: "Nasdaq Composite", value: "26,333.03", change: "+0.30%", status: "positive", estimated: false },
    { symbol: "DJI", name: "Dow Jones", value: "52,573.29", change: "+0.37%", status: "positive", estimated: false },
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,512.03", change: "+1.23%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,568.56", change: "-0.03%", status: "negative", estimated: false },
    { symbol: "N225", name: "Nikkei 225", value: "63,549.72", change: "-0.72%", status: "negative", estimated: false }
  ],
  ...
  instruments: [
    ...
    },
    {
      ...
      currentPrice: "4.95% (Rendimento)",
      changePercent: "+0.12 pt",
      status: "positive",
      estimated: false,
      historicalYields: [
    ...
    },
    {
      ...
      currentPrice: "4.56% (Rendimento)",
      changePercent: "+0.13 pt",
      status: "positive",
      estimated: false,
      historicalYields: [
    ...
    },
    {
      ...
      currentPrice: "3.73% (Rendimento)",
      changePercent: "-0.10 pt",
      status: "negative",
      estimated: false,
      historicalYields: [
  ...
  macro: {
    ...
    indicators: [
      { name: "Inflazione USA (CPI)", actual: "3.7%", previous: "3.5%", status: "Elevata" },
      { name: "PIL USA (trim. annualizzato)", actual: "1.5%", previous: "2.1%", status: "Crescita moderata" },
      { name: "Tasso Disoccupazione USA", actual: "4.1%", previous: "4.1%", status: "Piena occupazione" },
