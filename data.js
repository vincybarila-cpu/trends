...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,924.92", change: "-0.93%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "24,739.17", change: "-1.04%", status: "negative", estimated: false },
