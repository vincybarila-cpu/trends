...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,357.93", change: "-0.42%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,245.91", change: "-0.74%", status: "negative", estimated: false },
