...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,666.80", change: "-1.80%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,792.79", change: "-1.77%", status: "negative", estimated: false },
