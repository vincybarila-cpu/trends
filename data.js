...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "DJI", name: "Dow Jones", value: "53,417.16", change: "+1.25%", status: "positive", estimated: false },
    ...
    { symbol: "N225", name: "Nikkei 225", value: "65,804.88", change: "+0.42%", status: "positive", estimated: false }
  ],
