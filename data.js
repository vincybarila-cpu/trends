...
export const TRENDS_DATA = {
  indices: [
    { symbol: "SPX", name: "S&P 500", value: "7,764.70", change: "+1.66%", status: "positive", estimated: false },
    { symbol: "IXIC", name: "Nasdaq Composite", value: "27,122.09", change: "+2.66%", status: "positive", estimated: false },
    { symbol: "DJI", name: "Dow Jones", value: "52,048.83", change: "+0.52%", status: "positive", estimated: false },
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,371.54", change: "-0.03%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,575.01", change: "-0.55%", status: "negative", estimated: false },
  ...
  instruments: [
    ...
    },
    {
      ...
      currentPrice: "4.76% (Rendimento)",
      changePercent: "+0.09 pt",
      status: "positive",
      estimated: false,
      historicalYields: [
