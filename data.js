...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,853.26", change: "-0.31%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,009.56", change: "-0.45%", status: "negative", estimated: false },
