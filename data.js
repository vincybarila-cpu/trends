...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,720.95", change: "-0.56%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,952.26", change: "-0.67%", status: "negative", estimated: false },
