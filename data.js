...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,764.82", change: "-0.99%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "24,950.01", change: "-0.25%", status: "negative", estimated: false },
