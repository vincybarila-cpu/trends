...
export const TRENDS_DATA = {
  indices: [
    { symbol: "SPX", name: "S&P 500", value: "7,673.52", change: "-0.96%", status: "negative", estimated: false },
    { symbol: "IXIC", name: "Nasdaq Composite", value: "26,421.41", change: "-0.61%", status: "negative", estimated: false },
    { symbol: "DJI", name: "Dow Jones", value: "52,786.07", change: "-1.68%", status: "negative", estimated: false },
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,815.88", change: "-0.79%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,784.44", change: "-0.85%", status: "negative", estimated: false },
    { symbol: "N225", name: "Nikkei 225", value: "65,142.78", change: "-0.19%", status: "negative", estimated: false }
  ],
