...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,957.05", change: "-0.27%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,895.25", change: "-0.58%", status: "negative", estimated: false },
