...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "N225", name: "Nikkei 225", value: "64,837.56", change: "-0.47%", status: "negative", estimated: false }
  ],
