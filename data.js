...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,667.35", change: "-0.09%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,315.93", change: "-0.01%", status: "negative", estimated: false },
