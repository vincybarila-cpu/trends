...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "N225", name: "Nikkei 225", value: "66,182.78", change: "-0.34%", status: "negative", estimated: false }
  ],
