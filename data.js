...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,859.97", change: "-0.11%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,865.46", change: "-0.40%", status: "negative", estimated: false },
