...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,658.42", change: "-0.68%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,959.67", change: "-0.65%", status: "negative", estimated: false },
