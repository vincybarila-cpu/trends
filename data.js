...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,049.33", change: "+0.50%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,993.27", change: "+0.60%", status: "positive", estimated: false },
