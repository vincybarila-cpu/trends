...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,250.49", change: "-0.62%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,259.49", change: "-0.68%", status: "negative", estimated: false },
