...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "52,924.52", change: "-1.24%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,088.02", change: "-0.95%", status: "negative", estimated: false },
