...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,994.00", change: "-1.18%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,959.31", change: "-2.30%", status: "negative", estimated: false },
