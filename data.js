...
export const TRENDS_DATA = {
  indices: [
    { symbol: "SPX", name: "S&P 500", value: "7,591.70", change: "-1.07%", status: "negative", estimated: false },
    { symbol: "IXIC", name: "Nasdaq Composite", value: "26,081.72", change: "-1.29%", status: "negative", estimated: false },
    { symbol: "DJI", name: "Dow Jones", value: "52,064.10", change: "-1.37%", status: "negative", estimated: false },
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "51,807.40", change: "-0.71%", status: "negative", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "25,361.15", change: "-2.49%", status: "negative", estimated: false },
    { symbol: "N225", name: "Nikkei 225", value: "63,785.76", change: "-2.28%", status: "negative", estimated: false }
  ],
