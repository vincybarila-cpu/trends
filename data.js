...
export const TRENDS_DATA = {
  indices: [
    ...
    { symbol: "FTSEMIB", name: "FTSE MIB", value: "53,765.04", change: "+0.13%", status: "positive", estimated: false },
    { symbol: "GDAXI", name: "DAX 40", value: "26,440.26", change: "+0.53%", status: "positive", estimated: false },
